...
function socketconnection(){// Socket
    ...
    function refreshUsers(){
        $.ajax({
            type: "GET",
            url: baseUrl+'/adminChat/get/Chat/users',
    ...
    function read(id){
        $.ajax({
            type: "GET",
            url: baseUrl+'/adminChat/get/messageread/'+id,
            success: function(res) {
...
function getChat(id){
    ...
    if(messages[id]==null){
        $.ajax({
            type: "GET",
            url: baseUrl+'/adminChat/get/ChatByUser/'+id,
            success: function(res) {
...
function sendMessage(){
    ...
    if($('#inputMessage').val()!='' || file_data!=undefined){
        $.ajax({
            type: "POST",
            url: baseUrl+'/adminChat/save/Chat',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
...
function getMessageById(){
        $.ajax({
            type: "GET",
            url: baseUrl+'/adminChat/getMessageById/'+id,
            success: function(res) {
...
function arraySearch(val) {
  ...
  function MessageRequest(data){
    ...
    $.ajax({
        type: "GET",
        url: baseUrl+'/adminChat/get/getChatUserById/'+data.sendTo,
        success: function(res) {
