    ...
    <div class="row">
    	<div class="col-md-3">
    		<div class="widget widget-memebers">
                ...
                <a style="padding:9px;border-radius: 8px;width: 100%;" href="{{ url('profile/friend/sentrequests') }}" class="btn btn-success">Sent Requests</a>
            </div>
    	</div>
        <div class="col-md-9">
            <div id="user-view" class="user-grid-view">
                <div class="row gutters-20">
                	...
                	@php
                		$userrequest = App\Models\user::find($r->recipient_id);
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6" style="opacity: 1;">
                        <div class="widget-author">
                            ...
                            <ul class="author-statistics">
                                <li>
                                    <a style="padding:9px;border-radius: 8px;" href="{{ url('profile/cancel') }}/{{ $userrequest->id }}" class="btn btn-success"><i class="icofont-plus"></i> Cancel Request </a>
                                </li>
                            </ul>
                        </div>
                    </div>
